                            ...
                            <table id="datatable" class="table table-striped table-bordered">
                              ...
                              $resultado = consultar("usuario","SI");
                                  ...
                                  foreach ($resultado as $row) {
                                      ...
                                      echo "<tbody><tr>
                                            <td><a class='btn_editarActivo' title='Editar' href='p-nuevousuario.php?id_usu=".$id_usu."'><i class='fa fa-pencil'></i>".DatoREQDB("nombres","registro","idregistro=".DatoREQDB("idregistro","usuario","idusuario=".$row["idusuario"]."")."")."</a></td>
