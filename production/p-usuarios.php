                          ...
                          <table id="datatable" class="table table-striped table-bordered">
                            ...
                            $resultado = consultar("usuario","SI");
                                ...
                                foreach ($resultado as $row) {
                                    ...
                                    echo "<tbody><tr>
                                          <td><a class='btn_editarActivo' title='Editar' href='p-nuevousuario.php?id_usu=".base64_encode($id_usu)."'><i class='fa fa-pencil'></i>".DatoREQDB("nombres","registro","idregistro=".DatoREQDB("idregistro","usuario","idusuario=".$row["idusuario"]."")."")."</a></td>
                          ...
                          <div class="ln_solid"></div>
                            <div class="form-group">
                              <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-0">
                                <a title="Nuevo usuario" class="btn_new" href='p-nuevousuario.php'>Nuevo usuario</a>
                              </div>
                            </div>
                        </div>
                      </div>
                      ...
                      <div class="x_panel">
                        <div class="x_content">
                          ...
                          <div class="ln_solid"></div>
                            <div class="form-group">
                              <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-0">
                                <a title="Nuevo curso" class="btn_new" href='p-nuevousuario.php'>Nuevo usuario</a>
                              </div>
                            </div>
                        </div>
                      </div>
