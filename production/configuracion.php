                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form id="" data-parsley-validate class="form-horizontal form-label-left" method="post" action="">
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          <select id="id_curso" name="id_curso" class="form-control col-md-7 col-xs-12">
                            ...
                            <?php   
                              //Consulta de todos los cursos
                              $resultado = consultar("profesion", "SI");

                                  foreach ($resultado as $row) {
                                      echo '<option value='.$row["idprofesion"].'>'.$row["profesion"].'</option>';
                                  }
                              ?>
                          </select>
                        </div>
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          <input type="text" id="estado_civil" name="estado_civil" placeholder="PROFESIÓN" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo $nombre_gru;?>">
                        </div>
                      </div>
                      <div class="ln_solid"></div>
                      <div class="form-group">
